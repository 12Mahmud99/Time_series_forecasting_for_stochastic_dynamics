...
#SBATCH --gres=gpu:1 
#SBATCH --mem=24G
#SBATCH --output=logs/nftsf/nips_electricity_datasets.%j.out
#SBATCH --error=logs/nftsf/nips_electricity_datasets.%j.err
...
mkdir -p checkpoints_custom/nf_encoder_k3/electricity_nips_parallel/cnn 
mkdir -p checkpoints_custom/nf_encoder_k3/traffic_nips/cnn 
...
python train/NFTSF/train_nftsf_with_encoder_nips.py \
    ...
    --output_dir ./checkpoints_custom/nf_encoder_k3/electricity_nips_parallel/cnn \
