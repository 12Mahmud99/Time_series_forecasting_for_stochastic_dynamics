...
#SBATCH --gres=gpu:1 
#SBATCH --mem=24G
#SBATCH --output=logs/nf5.%j.out
#SBATCH --error=logs/nf5.err
#SBATCH --mail-user==###
...
python train/NFTSF/train_nftsf_all.py     --data_path data_150_150/double_well_train.npz     --output_dir ./checkpoints_150_150/nf_encoder_k3/double_well/cnn     --model_name double_well --n_past 150 --n_future 150   --epochs 1000 --batch_size 4096     --val_fraction 0.1        --device cuda
