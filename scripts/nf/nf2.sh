...
#SBATCH --gres=gpu:1 
#SBATCH --mem=24G
#SBATCH --output=logs/nftsf/nf2.%j.out
#SBATCH --error=logs/nftsf/nf2.%j.err
...
mkdir -p checkpoints_25_25/nf_encoder_k3/double_well_test/cnn
...
python utils/plot_forecasts.py     --input results/nf_encoder/electricity_nips_cnn_k3_100_100.npz     --out_dir plots/electricity/nftsf_100_100/     --n_traj 6     --skip_denorm     --grid --n_cols 3    --raw_npz data_raw/electricity_nips_test.npz