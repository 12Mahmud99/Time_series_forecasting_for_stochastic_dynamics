...
#SBATCH --gres=gpu:1 
#SBATCH --mem=24G
#SBATCH --output=logs/nftsf/nf13.%j.out
#SBATCH --error=logs/nftsf/nf13.%j.err
...
mkdir -p checkpoints_25_25/nf_encoder_k3/traffic_nips/cnn 
mkdir -p checkpoints_50_50/nf_encoder_k3/traffic_nips/cnn 
mkdir -p checkpoints_100_100/nf_encoder_k3/traffic_nips/cnn 
...
python train/NFTSF/train_nftsf_with_encoder_nips.py \
    --data_path data_raw/traffic_nips_train.npz \
    --output_dir ./checkpoints_100_100/nf_encoder_k3/traffic_nips/cnn \
    --model_name traffic \
    --n_past 100 \
    --n_future 100 \
    --epochs 1000 \
