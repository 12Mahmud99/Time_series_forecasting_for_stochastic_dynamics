...
#SBATCH --gres=gpu:1 
#SBATCH --mem=24G
#SBATCH --output=logs/nftsf/nf9.%j.out
#SBATCH --error=logs/nftsf/nf9.%j.err
...
python train/NFTSF/train_nftsf_with_encoder_nips.py \
    --data_path data_raw/electricity_nips_train.npz \
    --output_dir ./checkpoints_100_100/nf_encoder_k3/electricity_nips/cnn \
...
python eval/NF/forecast_nf_encoder_nips.py   \
    --model_path ./checkpoints_25_25/nf_encoder_k3/double_well_test/cnn/model.pth   \
    --config ./checkpoints_25_25/nf_encoder_k3/double_well/cnn/config.json  \
    --data_path data/double_well_test.npz  \
    --out results/nf_encoder/double_well_cnn_k3_25_25_test.npz  \
    --seed 123   --n_samples 1000 --batch_size 64 --device cuda
