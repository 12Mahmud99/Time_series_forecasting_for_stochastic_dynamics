#!/usr/bin/env bash
#SBATCH --job-name=syn_tsdiff_150_150
...
#SBATCH --qos=public
#SBATCH --mem=24G
#SBATCH --output=logs/tsdiff_cond/TSDIff_150_150_syn.%j.out
#SBATCH --error=logs/tsdiff_cond/TSDIff_150_150_syn.err
...
mkdir -p checkpoints_150_150/tsdiff_cond/double_well
mkdir -p checkpoints_150_150/tsdiff_cond/single_well
...
python utils/compare_nips.py     --results electricity_nips:tsdiff_cond:results/tsdiff_cond/electricity_nips_50.npz  electricity_nips:tsdiff_mse:results/tsdiff_mse/electricity_nips_mse_03_50.npz electricity_nips:tsdiff_q:results/tsdiff_q/electricity_nips_q_4_50.npz   --data_npz electricity_nips:data_raw/electricity_nips_test.npz     --output_dir ./electricity     --n_traj_show 3     --seed 42
