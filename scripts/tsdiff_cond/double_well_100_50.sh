#!/usr/bin/env bash
#SBATCH --job-name=TSDIff_100_50_dw
...
#SBATCH --gres=gpu:1  
#SBATCH --mem=24G
#SBATCH --output=logs/tsdiff_cond/TSDIff_100_50_dw.%j.out
#SBATCH --error=logs/tsdiff_cond/TSDIff_100_50_dw.err
...
mkdir -p checkpoints_100_50/tsdiff_cond/alanine_phi
mkdir -p checkpoints_100_50/tsdiff_cond/alanine_psi
mkdir -p checkpoints_100_50/tsdiff_cond/double_well
mkdir -p checkpoints_100_50/tsdiff_cond/single_well
...
python train/TSDiff/train_cond_tsdiff.py \
        ...
        --config configs/tsdiff_cond_train/double_well_100_50.yaml \
        --out_dir checkpoints_100_50/tsdiff_cond/double_well
