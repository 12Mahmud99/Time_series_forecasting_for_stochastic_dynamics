#!/usr/bin/env bash
#SBATCH --job-name=TSDIff_100_50_sw
...
#SBATCH --gres=gpu:1  
#SBATCH --mem=24G
#SBATCH --output=logs/tsdiff_cond/TSDIff_100_50_sw.%j.out
#SBATCH --error=logs/tsdiff_cond/TSDIff_100_50_sw.err
...
python train/TSDiff/train_cond_tsdiff.py \
        ...
        --config configs/tsdiff_cond_train/single_well_100_50.yaml \
        --out_dir checkpoints_100_50/tsdiff_cond/single_well
