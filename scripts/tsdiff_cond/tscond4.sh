...
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --output=logs/tsdiff_cond/tcond4.%j.out
#SBATCH --error=logs/tsdiff_cond/tcond4.err
...
python train/TSDiff/train_cond_tsdiff.py \
        ...
        --config configs/tsdiff_cond_train/electricity_nips_50_50.yaml \
        --out_dir checkpoints_50_50/tsdiff_cond/electricity_nips