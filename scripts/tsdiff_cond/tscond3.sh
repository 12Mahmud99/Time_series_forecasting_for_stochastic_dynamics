...
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --output=logs/tsdiff_cond/tcond3.%j.out
#SBATCH --error=logs/tsdiff_cond/tcond3.err
...
python train/TSDiff/train_cond_tsdiff.py \
        ...
        --config configs/tsdiff_cond_train/electricity_nips_25_25.yaml \
        --out_dir checkpoints_25_25/tsdiff_cond/electricity_nips