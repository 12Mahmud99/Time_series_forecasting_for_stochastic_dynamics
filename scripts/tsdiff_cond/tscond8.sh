...
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --output=logs/tsdiff_cond/tcond7.%j.out
#SBATCH --error=logs/tsdiff_cond/tcond7.err
...
python train/TSDiff/train_cond_tsdiff.py \
        ...
        --config configs/tsdiff_cond_train/traffic_nips_25_25.yaml \
        --out_dir checkpoints_25_25/tsdiff_cond/traffic_nips