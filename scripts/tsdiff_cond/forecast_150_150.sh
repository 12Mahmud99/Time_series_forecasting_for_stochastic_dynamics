#!/usr/bin/env bash
#SBATCH --job-name=forecast_150_150
...
#SBATCH --mem=32G
#SBATCH --output=logs/tsdiff_cond/forecast_150_150.%j.out
#SBATCH --error=logs/tsdiff_cond/forecast_150_150.err
...
python eval/TSDiff/forecast_tsdiff_cond.py   \
        --config configs/tsdiff_forecast/double_well_cond_150_150.yaml  \
        --dataset_path gluonts_datasets_150_150/double_well \
        --out results/tsdiff_cond/double_well_150_150.npz

python eval/TSDiff/forecast_tsdiff_cond.py   \
        --config configs/tsdiff_forecast/double_well_cond_150_150.yaml  \
        --dataset_path gluonts_datasets_150_150/double_well \
        --out results/tsdiff_cond/double_well_150_150_2.npz

python eval/TSDiff/forecast_tsdiff_cond.py   \
        --config configs/tsdiff_forecast/double_well_cond_150_150.yaml  \
        --dataset_path gluonts_datasets_150_150/double_well \
        --out results/tsdiff_cond/double_well_150_150_3.npz




python eval/TSDiff/forecast_tsdiff_cond.py   \
        --config configs/tsdiff_forecast/single_well_cond_150_150.yaml  \
        --dataset_path gluonts_datasets_150_150/single_well \
        --out results/tsdiff_cond/single_well_150_150.npz

python eval/TSDiff/forecast_tsdiff_cond.py   \
        --config configs/tsdiff_forecast/single_well_cond_150_150.yaml  \
        --dataset_path gluonts_datasets_150_150/single_well \
        --out results/tsdiff_cond/single_well_150_150_2.npz

python eval/TSDiff/forecast_tsdiff_cond.py   \
        --config configs/tsdiff_forecast/single_well_cond_150_150.yaml  \
        --dataset_path gluonts_datasets_150_150/single_well \
        --out results/tsdiff_cond/single_well_150_150_3.npz
