...
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
#SBATCH --output=logs/tsdiff_cond/tcond2.%j.out
#SBATCH --error=logs/tsdiff_cond/tcond2.err
...
python eval/TSDiff/forecast_tsdiff_cond_nips.py   \
        --config configs/tsdiff_forecast/electricity_nips_cond_100_100.yaml  \
        --dataset_path gluonts_datasets/electricity_nips \
        --out results/tsdiff_cond/electricity_nips_100_100_100_samples.npz 


python eval/TSDiff/forecast_tsdiff_cond_nips.py   \
        --config configs/tsdiff_forecast/electricity_nips_cond_25_25.yaml  \
        --dataset_path gluonts_datasets/electricity_nips \
        --out results/tsdiff_cond/electricity_nips_25_25.npz 


python eval/TSDiff/forecast_tsdiff_cond_nips.py   \
        --config configs/tsdiff_forecast/electricity_nips_cond_50_50.yaml  \
        --dataset_path gluonts_datasets/electricity_nips \
        --out results/tsdiff_cond/electricity_nips_50_50_100_samples.npz 