...
mkdir -p checkpoints_100_100/tsdiff_cond/alanine_psi
...
python train/TSDiff/train_cond_tsdiff.py \
        ...
        --config configs/tsdiff_cond_train/alanine_psi_100_100.yaml \
        --out_dir checkpoints_100_100/tsdiff_cond/alanine_psi