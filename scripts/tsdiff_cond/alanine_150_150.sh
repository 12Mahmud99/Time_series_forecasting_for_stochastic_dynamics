#!/usr/bin/env bash
#SBATCH --job-name=md_tsdiff_150_150
...
#SBATCH --gres=gpu:1  
#SBATCH --mem=24G
#SBATCH --output=logs/tsdiff_cond/TSDIff_150_150_md.%j.out
#SBATCH --error=logs/tsdiff_cond/TSDIff_150_150_md.err
...
mkdir -p checkpoints_150_150/tsdiff_cond/alanine_phi
mkdir -p checkpoints_150_150/tsdiff_cond/alanine_psi
...
python train/TSDiff/train_cond_tsdiff.py \
        ...
        --config configs/tsdiff_cond_train/alanine_psi_150_150.yaml \
        --out_dir checkpoints_150_150/tsdiff_cond/alanine_psi