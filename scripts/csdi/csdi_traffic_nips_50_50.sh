#!/usr/bin/env bash
#SBATCH --job-name=csdi_traffic_nips_50_50
...
#SBATCH --gres=gpu:1  
#SBATCH --mem=24G
#SBATCH --output=logs/csdi/csdi_traffic_nips_50_50.%j.out
#SBATCH --error=logs/csdi/csdi_traffic_nips_50_50.%j.err
...
python train/CSDI/train_csdi.py \
    --config configs/csdi_train/traffic_nips_50_50.yaml \
    --input  data_raw/traffic_nips_train.npz \
    --out    checkpoints_50_50/csdi/traffic_nips \
    --device cuda:0
