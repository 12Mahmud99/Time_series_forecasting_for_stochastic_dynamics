#!/usr/bin/env bash
#SBATCH --job-name=csdi_electricity_nips_50_50
...
#SBATCH --gres=gpu:1  
#SBATCH --mem=24G
#SBATCH --output=logs/csdi/csdi_electricity_nips_50_50.%j.out
#SBATCH --error=logs/csdi/csdi_electricity_nips_50_50.%j.err
...
python train/CSDI/train_csdi.py \
    ...
    --out    checkpoints_50_50/csdi/electricity_nips \
    --device cuda:0
