#!/usr/bin/env bash
#SBATCH --job-name=csdi_electricity_nips_25_25
...
#SBATCH --gres=gpu:1  
#SBATCH --mem=24G
#SBATCH --output=logs/csdi/csdi_electricity_nips_25_25.%j.out
#SBATCH --error=logs/csdi/csdi_electricity_nips_25_25.%j.err
...
python train/CSDI/train_csdi.py \
    ...
    --out    checkpoints_25_25/csdi/electricity_nips \
    --device cuda:0
