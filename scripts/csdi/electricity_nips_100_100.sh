#!/usr/bin/env bash
#SBATCH --job-name=csdi_electricity_nips_100_100
...
#SBATCH --gres=gpu:1  
#SBATCH --mem=24G
#SBATCH --output=logs/csdi/csdi_electricity_nips_100_100.%j.out
#SBATCH --error=logs/csdi/csdi_electricity_nips_100_100.%j.err
#SBATCH --mail-user=meahmed@asu.edu


mkdir -p results/csdi
mkdir -p checkpoints_25_25/csdi/electricity_nips
mkdir -p checkpoints_50_50/csdi/electricity_nips
mkdir -p checkpoints_100_100/csdi/electricity_nips
...
python train/CSDI/train_csdi.py \
    ...
    --out    checkpoints_100_100/csdi/electricity_nips \
    --device cuda:0
