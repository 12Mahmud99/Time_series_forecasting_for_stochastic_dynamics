#!/usr/bin/env bash
#SBATCH --job-name=CSDI_150_150_dw
...
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --output=logs/csdi/CSDI_150_150_dw.%j.out
#SBATCH --error=logs/csdi/CSDI_150_150_dw.%j.err
...
python train/TSDiff/train_cond_tsdiff.py \
        ...
        --config configs/tsdiff_cond_train/double_well_150_150.yaml \
        --out_dir checkpoints_150_150/tsdiff_cond/double_well