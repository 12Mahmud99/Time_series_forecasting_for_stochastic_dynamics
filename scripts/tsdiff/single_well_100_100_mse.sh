#!/usr/bin/env bash
#SBATCH --job-name=swuncondTSDIffmse
...
#SBATCH --mem=32G
#SBATCH --output=logs/swuncondTSDIffmse.%j.out
#SBATCH --error=logs/swuncondTSDIffmse.err
#SBATCH --mail-user==###
...
python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/single_well_mse_03_100_100.yaml  \
        --dataset_path gluonts_datasets/single_well \
        --out results/tsdiff_mse/single_well_mse_03_100_100.npz

python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/single_well_mse_03_100_100.yaml  \
        --dataset_path gluonts_datasets/single_well \
        --out results/tsdiff_mse/single_well_mse_03_100_100_2.npz

python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/single_well_mse_03_100_100.yaml  \
        --dataset_path gluonts_datasets/single_well \
        --out results/tsdiff_mse/single_well_mse_03_100_100_3.npz