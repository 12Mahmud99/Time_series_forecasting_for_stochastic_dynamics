#!/usr/bin/env bash
#SBATCH --job-name=traffic_nips_50_50
...
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --output=logs/uncond_tsdiff/traffic_nips_50_50.%j.out
#SBATCH --error=logs/uncond_tsdiff/traffic_nips_50_50.err
...
python train/TSDiff/train_tsdiff.py \
        ...
        --config configs/tsdiff_train/traffic_nips_50_50.yaml \
        --out_dir checkpoints_50_50/tsdiff/traffic_nips