#!/usr/bin/env bash
#SBATCH --job-name=dwuncondTSDIff_150_150
...
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --output=logs/dwuncondTSDIff_150_150.%j.out
#SBATCH --error=logs/dwuncondTSDIff_150_150.err
#SBATCH --mail-user==###
...
python train/TSDiff/train_tsdiff.py \
        ...
        --config configs/tsdiff_train/double_well_150_150.yaml \
        --out_dir checkpoints_150_150/tsdiff/double_well