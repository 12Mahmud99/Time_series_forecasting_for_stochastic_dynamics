...
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --output=logs/syn_uncond.%j.out
#SBATCH --error=logs/syn_uncond.err
#SBATCH --mail-user==###
...
mkdir -p checkpoints_150_150/tsdiff/alanine_psi
mkdir -p checkpoints_150_150/tsdiff/alanine_phi
mkdir -p checkpoints_150_150/tsdiff/single_well
mkdir -p checkpoints_150_150/tsdiff/double_well
...
python train/TSDiff/train_tsdiff.py \
        ...
        --config configs/tsdiff_train/single_well_150_150.yaml \
        --out_dir checkpoints_150_150/tsdiff/single_well