...
#SBATCH --mem=32G
#SBATCH --output=logs/uncond_tsdiff/electricity_q.%j.out
#SBATCH --error=logs/uncond_tsdiff/electricity_q.err
...
python eval/TSDiff/forecast_tsdiff_nips.py   \
        --config configs/tsdiff_forecast/electricity_q_4_25_25.yaml  \
        --dataset_path gluonts_datasets/electricity_nips \
        --out results/tsdiff_q/electricity_nips_q_4_25_25.npz 

python eval/TSDiff/forecast_tsdiff_nips.py   \
        --config configs/tsdiff_forecast/electricity_q_4_50_50.yaml  \
        --dataset_path gluonts_datasets/electricity_nips \
        --out results/tsdiff_q/electricity_nips_q_4_50_50.npz 

python eval/TSDiff/forecast_tsdiff_nips.py   \
        --config configs/tsdiff_forecast/electricity_q_4_100_100.yaml  \
        --dataset_path gluonts_datasets/electricity_nips \
        --out results/tsdiff_q/electricity_nips_q_4_100_100.npz 
