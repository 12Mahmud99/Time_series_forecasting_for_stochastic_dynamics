#!/usr/bin/env bash
#SBATCH --job-name=traffic_nips_25_25
...
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
#SBATCH --output=logs/uncond_tsdiff/traffic_nips_25_25.%j.out
#SBATCH --error=logs/uncond_tsdiff/traffic_nips_25_25.err
...
python train/TSDiff/train_tsdiff.py \
        ...
        --config configs/tsdiff_train/traffic_nips_25_25.yaml \
        --out_dir checkpoints_25_25/tsdiff/traffic_nips