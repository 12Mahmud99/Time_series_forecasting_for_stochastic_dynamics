...
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --output=logs/md_uncond.%j.out
#SBATCH --error=logs/md_uncond.err
#SBATCH --mail-user==###
...
python train/TSDiff/train_tsdiff.py \
        --dataset_path gluonts_datasets_150_150/alanine_psi \
        --config configs/tsdiff_train/alanine_psi_150_150.yaml \
        --out_dir checkpoints_150_150/tsdiff/alanine_psi

python train/TSDiff/train_tsdiff.py \
        --dataset_path gluonts_datasets_150_150/alanine_phi \
        --config configs/tsdiff_train/alanine_phi_150_150.yaml \
        --out_dir checkpoints_150_150/tsdiff/alanine_phi

python train/TSDiff/train_tsdiff_nips.py \
        --dataset_path gluonts_datasets/traffic_nips \
        --config configs/tsdiff_train/traffic_nips.yaml \
        --out_dir checkpoints_custom/tsdiff/traffic_nips