...
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
#SBATCH --output=logs/uncond_tsdiff/traffic_q.%j.out
#SBATCH --error=logs/uncond_tsdiff/traffic_q.err
...
python eval/TSDiff/forecast_tsdiff_nips.py   \
        --config configs/tsdiff_forecast/traffic_q_4.yaml  \
        --dataset_path gluonts_datasets/traffic_nips \
        --out results/tsdiff_q/traffic_nips_q_4.npz
