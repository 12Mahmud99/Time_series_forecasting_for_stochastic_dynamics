...
#SBATCH --mem=32G
#SBATCH --output=logs/infTSDIff2.%j.out
#SBATCH --error=logs/infTSDIff2.err
#SBATCH --mail-user==###
...
python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/single_well_mse_03_150_150.yaml  \
        --dataset_path gluonts_datasets_150_150/single_well \
        --out results/tsdiff_mse/single_well_mse_03_150_150.npz


python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/single_well_mse_03_150_150.yaml  \
        --dataset_path gluonts_datasets_150_150/single_well \
        --out results/tsdiff_mse/single_well_mse_03_150_150_2.npz

python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/single_well_mse_03_150_150.yaml  \
        --dataset_path gluonts_datasets_150_150/single_well \
        --out results/tsdiff_mse/single_well_mse_03_150_150_3.npz


python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/single_well_q_4_150_150.yaml  \
        --dataset_path gluonts_datasets_150_150/single_well \
        --out results/tsdiff_q/single_well_q_4_150_150.npz


python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/single_well_q_4_150_150.yaml  \
        --dataset_path gluonts_datasets_150_150/single_well \
        --out results/tsdiff_q/single_well_q_4_150_150_2.npz

python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/single_well_q_4_150_150.yaml  \
        --dataset_path gluonts_datasets_150_150/single_well \
        --out results/tsdiff_q/single_well_q_4_150_150_3.npz
