#!/usr/bin/env bash
#SBATCH --job-name=electricity_nips_25_25
...
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --output=logs/uncond_tsdiff/electricity_nips_25_25.%j.out
#SBATCH --error=logs/uncond_tsdiff/electricity_nips_25_25.err
...
python train/TSDiff/train_tsdiff.py \
        ...
        --config configs/tsdiff_train/electricity_nips_25_25.yaml \
        --out_dir checkpoints_25_25/tsdiff/electricity_nips