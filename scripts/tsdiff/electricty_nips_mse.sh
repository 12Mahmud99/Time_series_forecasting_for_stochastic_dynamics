#!/usr/bin/env bash
#SBATCH --job-name=electricity_nips_mse
...
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
#SBATCH --output=logs/uncond_tsdiff/electricity_nips_mse.%j.out
#SBATCH --error=logs/uncond_tsdiff/electricity_nips_mse.err
...
python eval/TSDiff/forecast_tsdiff_nips.py   \
        --config configs/tsdiff_forecast/electricity_mse_03_50_50.yaml  \
        --dataset_path gluonts_datasets/electricity_nips \
        --out results/tsdiff_mse/electricity_nips_mse_03_50_50_100_samples.npz

python eval/TSDiff/forecast_tsdiff_nips.py   \
        --config configs/tsdiff_forecast/electricity_mse_03_100_100.yaml  \
        --dataset_path gluonts_datasets/electricity_nips \
        --out results/tsdiff_mse/electricity_nips_mse_03_100_100_100_samples.npz