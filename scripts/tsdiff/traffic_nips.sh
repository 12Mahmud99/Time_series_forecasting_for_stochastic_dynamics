#!/usr/bin/env bash
#SBATCH --job-name=uncond_tsdiff_traffic_nips
...
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --output=logs/uncond_tsdiff/uncond_tsdiff_traffic_nips.%j.out
#SBATCH --error=logs/uncond_tsdiff/uncond_tsdiff_traffic_nips.err
