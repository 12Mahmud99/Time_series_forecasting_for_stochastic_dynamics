#!/usr/bin/env bash
#SBATCH --job-name=psiuncondTSDIff
...
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --output=logs/psiuncondTSDIff.%j.out
#SBATCH --error=logs/psiuncondTSDIff.err
#SBATCH --mail-user==###
...
python train/TSDiff/train_tsdiff.py \
        ...
        --config configs/tsdiff_train/alanine_psi_100_50.yaml \
        --out_dir checkpoints_100_50/tsdiff/alanine_psi
