#!/usr/bin/env bash
#SBATCH --job-name=swuncondTSDIff
...
#SBATCH --mem=32G
#SBATCH --output=logs/swuncondTSDIff.%j.out
#SBATCH --error=logs/swuncondTSDIff.err
#SBATCH --mail-user==###
...
python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/single_well_q_4_100_100.yaml  \
        --dataset_path gluonts_datasets/single_well \
        --out results/tsdiff_q/single_well_q_4_100_100_1.npz

python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/single_well_q_4_100_100.yaml  \
        --dataset_path gluonts_datasets/single_well \
        --out results/tsdiff_q/single_well_q_4_100_100_2.npz

python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/single_well_q_4_100_100.yaml  \
        --dataset_path gluonts_datasets/single_well \
        --out results/tsdiff_q/single_well_q_4_100_100_3.npz