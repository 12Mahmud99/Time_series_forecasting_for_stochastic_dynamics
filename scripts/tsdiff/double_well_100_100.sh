#!/usr/bin/env bash
#SBATCH --job-name=dwuncondTSDIff
...
#SBATCH --mem=32G
#SBATCH --output=logs/dwuncondTSDIff.%j.out
#SBATCH --error=logs/dwuncondTSDIff.err
#SBATCH --mail-user==###
...
python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/double_well_q_4_100_100.yaml  \
        --dataset_path gluonts_datasets/double_well \
        --out results/tsdiff_q/double_well_q_4_100_100_1.npz

python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/double_well_q_4_100_100.yaml  \
        --dataset_path gluonts_datasets/double_well \
        --out results/tsdiff_q/double_well_q_4_100_100_2.npz

python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/double_well_q_4_100_100.yaml  \
        --dataset_path gluonts_datasets/double_well \
        --out results/tsdiff_q/double_well_q_4_100_100_3.npz