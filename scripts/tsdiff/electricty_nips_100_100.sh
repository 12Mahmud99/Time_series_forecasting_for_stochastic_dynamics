#!/usr/bin/env bash
#SBATCH --job-name=electricity_nips_100_100
...
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --output=logs/uncond_tsdiff/electricity_nips_100_100.%j.out
#SBATCH --error=logs/uncond_tsdiff/electricity_nips_100_100.err
...
mkdir -p checkpoints_25_25/tsdiff/electricity_nips
mkdir -p checkpoints_50_50/tsdiff/electricity_nips

mkdir -p checkpoints_100_100/tsdiff/electricity_nips
...
python train/TSDiff/train_tsdiff.py \
        ...
        --config configs/tsdiff_train/electricity_nips_100_100.yaml \
        --out_dir checkpoints_100_100/tsdiff/electricity_nips