#!/usr/bin/env bash
#SBATCH --job-name=phiuncondTSDIff
...
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --output=logs/phiuncondTSDIff.%j.out
#SBATCH --error=logs/phiuncondTSDIff.err
#SBATCH --mail-user==###
...
python train/TSDiff/train_tsdiff.py \
        ...
        --config configs/tsdiff_train/alanine_phi_100_50.yaml \
        --out_dir checkpoints_100_50/tsdiff/alanine_phi
